...
async function main() {
	const to = 'timatur242005@gmail.com';
	console.log(`Sending test email to ${to}...`);

	const { data, error } = await resend.emails.send({
		from: 'GenSprite <founders@gensprite.ai>',
		to,
		replyTo: 'timur@triangleint.com',
		subject: 'Stripe is live — buy tokens instantly',
		html: emailShell(`
  ...
  <p style="margin:16px 0 0; font-family:'DM Sans',system-ui,sans-serif; font-size:15px; color:#a1a1aa; line-height:1.7;">
    Hey, thanks for being part of GenSprite! We really appreciate you using our platform to create game assets.
  </p>
